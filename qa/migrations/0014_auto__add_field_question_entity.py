...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.entity'
        db.add_column(u'qa_question', 'entity',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions', null=True, to=orm['entities.Entity']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.entity'
        db.delete_column(u'qa_question', 'entity_id')
    ...
    models = {
        ...
        u'qa.question': {
            ...
            'content': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
