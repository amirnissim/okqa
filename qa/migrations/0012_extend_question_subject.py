...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'qa_question', 'subject', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):
        # Changing field 'Question.subject'
        db.alter_column(u'qa_question', 'subject', self.gf('django.db.models.fields.CharField')(max_length=80))
