...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qa_answer_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('answer', models.ForeignKey(orm['qa.answer'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('qa_answer_sites', ['answer_id', 'site_id'])

        # Adding M2M table for field sites on 'Question'
        db.create_table('qa_question_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['qa.question'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('qa_question_sites', ['question_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field sites on 'Answer'
        db.delete_table('qa_answer_sites')

        # Removing M2M table for field sites on 'Question'
        db.delete_table('qa_question_sites')
