...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionFlag'
        db.create_table('qa_questionflag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flags', to=orm['qa.Question'])),
            ('reporter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flags', to=orm['auth.User'])),
        ))
        db.send_create_signal('qa', ['QuestionFlag'])

        # Adding field 'Question.flags_count'
        db.add_column('qa_question', 'flags_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QuestionFlag'
        db.delete_table('qa_questionflag')

        # Deleting field 'Question.flags_count'
        db.delete_column('qa_question', 'flags_count')
    ...
    models = {
        ...
        'qa.questionflag': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flags'", 'to': "orm['qa.Question']"}),
            'reporter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flags'", 'to': "orm['auth.User']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'qa.questionupvote': {
