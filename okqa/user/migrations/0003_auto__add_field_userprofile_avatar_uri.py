...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.avatar_uri'
        db.add_column('user_userprofile', 'avatar_uri',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.avatar_uri'
        db.delete_column('user_userprofile', 'avatar_uri')
