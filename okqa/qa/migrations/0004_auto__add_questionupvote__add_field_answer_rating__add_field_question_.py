...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionUpvote'
        db.create_table('qa_questionupvote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='upvotes', to=orm['qa.Question'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='upvotes', to=orm['auth.User'])),
        ))
        db.send_create_signal('qa', ['QuestionUpvote'])

        # Adding field 'Answer.rating'
        db.add_column('qa_answer', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.rating'
        db.add_column('qa_question', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QuestionUpvote'
        db.delete_table('qa_questionupvote')

        # Deleting field 'Answer.rating'
        db.delete_column('qa_answer', 'rating')

        # Deleting field 'Question.rating'
        db.delete_column('qa_question', 'rating')
